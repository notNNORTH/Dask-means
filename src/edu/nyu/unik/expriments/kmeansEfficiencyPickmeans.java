...
public class kmeansEfficiencyPickmeans {

	public kmeansEfficiencyPickmeans() {
	...
	//	dimensions = new int[] {2};// test the parameters
		...
		kvalue = new int[]{100, 1000, 5000, 10000, 20000, 30000};//100, 1000,
		kvalue = new int[]{100, 1000};
	...
	//	runkmeans.staticKmeans(true, false, true);//test the functionality		
		...
		// test the fast algorithm itself for various parameters, comment other methods
		/*
